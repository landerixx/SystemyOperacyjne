...
int findIndexOfOptimalVictim(int indexBledu){
	...
	public void Fifo(){
		...
		for(Odwolanie od: ciagOdwolan){
			...
			System.out.print("nr "+ i + "  "); pokazTabliceRamek();	
			if(flaga)
				System.out.println("   BLAD STRONY, ofiara---->" + victim);
			else
				System.out.println();
			i++;
	...
	int i=0;
		...
		//addLast(tablicaRamek, od);
			...
			System.out.print("nr "+ i + ", wchodzi odwolanie: [" + od.wartosc +"]   "); pokazTabliceRamek();
			if(flaga)
				System.out.println("   BLAD STRONY, ofiara---->" + victim );
			else
				System.out.println();
	...
	public void Optimal(){
		...
		for(Odwolanie od: ciagOdwolan){
			...
			System.out.print("nr "+ zegar + ", wchodzi odwolanie: [" + od.wartosc +"]   "); pokazTabliceRamek();
			if(flaga)
				System.out.println("   BLAD STRONY, ofiara---->" + victim);
			else
				System.out.println();
