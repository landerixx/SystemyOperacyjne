...
public class FCFS {
	...
	public void fcfsAlgorithm(ArrayList<Proces> ciagProcesow) {
		...
		while (!reprezentacjaWejsciowa.isEmpty() || !procesyGotowe.isEmpty()) {
			...
			if (procesyGotowe.size() > 0) { // jezeli cos jest w kolejce
				Collections.sort(procesyGotowe); // sortujemy procesy Gotowe po
													// czasie zgloszenia
				...
				// jezeli nie ma zadnego procesu w kolejce zwiekszamy czas o 1
				czasGlobalny++;
