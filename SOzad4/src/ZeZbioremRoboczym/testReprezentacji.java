...
public class testReprezentacji {
	...
	public static void testPrzydzielRamkiProporcjonalnie(){
		...
		Algorithms instance= new Algorithms(procesy, iloscRamek,10);
	...
	public static void testLruKsiazka(){
		...
		Algorithms instance= new Algorithms(procesy, 3,10);
		instance.wyswietlProcesy();
	...
	public static void testujeLRUrozneRamkiPanProces() throws IOException, ClassNotFoundException{
		
		
		int iloscProcesow=10;
		int minIloscOdwolan=50;
		int maxIloscOdwolan=500;
		
		/*
		Random rand= new Random();
		Proces panProces = new Proces(rand.nextInt(maxIloscOdwolan-minIloscOdwolan)+minIloscOdwolan, 1000);
		Proces.save("procek", panProces);
		*/
		
		Proces panProces=null;
		int iloscRamek=25;
		panProces=Proces.restore("procek");
		System.out.println("moj pan proces!        " + panProces);
		ArrayList<Proces> procesy= ReprezentacjaProcesow.generujRandCiagProcesowLokalnoscPrzylegla
				(iloscProcesow, minIloscOdwolan, maxIloscOdwolan);
		procesy.add(panProces);
	...
	public static void LRUpanPROCES() throws ClassNotFoundException, IOException{
	...
	Proces panProces=null;
		...
		System.out.println("moj pan proces!         " + panProces);
		for(int i=0; i<4;i++){
			panProces.przydzielonaIloscRamek=ramki;
			System.out.print("U pana procesa      ");
			LRU.LRUalgorithm(panProces);
			System.out.println("dla " + panProces.przydzielonaIloscRamek + " Ramek");
			panProces.clear();
			ramki++;
		}
